...
public class UnityThread : MonoBehaviour
{
    ...
    public static void SetUnityValue(Action action)
    {
        var timeToWait = 5000;
        var timeStarted = DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond;
        ...
        while (!setValues)
        {
            if ((DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond) - timeStarted > timeToWait)
            {
                return;
            }
        }
